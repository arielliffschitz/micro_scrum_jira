...
CREATE TABLE `user_team` (
  ...
  `id_team` binary(16) NOT NULL,
  PRIMARY KEY (`id_user`,`id_team`),
  KEY `FK4sbpy5wmmtkuyvq4jc3j22j4w` (`id_team`),
  CONSTRAINT `FK4sbpy5wmmtkuyvq4jc3j22j4w` FOREIGN KEY (`id_team`) REFERENCES `team` (`id`),
  CONSTRAINT `FK7ttipce8r654i7okybp2d2yt5` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
