...
CREATE TABLE `task_audit` (
  ...
  `created-at` datetime(6) DEFAULT NULL,
  `created-by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `description` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_520_ci DEFAULT NULL,
  `estimate` int DEFAULT NULL,
  `project-key` int DEFAULT NULL,
  `sprint-key` int DEFAULT NULL,
...
--
-- Dumping data for table `task_audit`
--

LOCK TABLES `task_audit` WRITE;
/*!40000 ALTER TABLE `task_audit` DISABLE KEYS */;
INSERT INTO `task_audit` VALUES (_binary 'Ü˜\Œ\Í1ï@◊ùI©î÷á','2026-02-09 15:18:03.000000','josemaria@email.com','Create OAuth2 login flow and JWT issuance',3,10,1,1,'Implement login endpoint');
